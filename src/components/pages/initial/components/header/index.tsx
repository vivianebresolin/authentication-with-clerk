...
export default function Header() {
  return(
    <header className="bg-[#0077B6] pt-6 pb-4 px-4 flex flex-col items-center gap-8 w-full">
      ...
      <h1 className="text-4xl sm:text-5xl text-center text-white">Authentication<br/>with Clerk</h1>
      <button className="w-full sm:w-auto bg-black rounded-md shadow py-2 px-4 text-sm">
        <a href="https://clerk.com/"target="_blank" className="text-white">Learn more about Clerk</a>
      </button>
    </header>
  );
}